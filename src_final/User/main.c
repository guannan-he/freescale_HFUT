...
//定义舵机参数
#define     Step_Right       3625//3525 //总线频率改变，值需要重新标定 约30度
#define     Step_Middle      2825//2578//2350 //总线频率改变，中值需要重新标定
#define     Step_Left        2025//1500 //总线频率改变，值需要重新标定 约30度
//全局设置类参数定义-何冠男
#define     encode_limit     400//跑飞步数设置
#define     stop_count       2//停车阈值
#define     mtr_gate    20     //电机控制阈值
#define     uart_gate   25      //串口传输间隔
#define         mz_gate         500
...
duty=880，电机20%
  ...
  *********************全局变量段****************************/
  ...
  int target_speed = 300;//目前期望车速
  int current_duty=1050;//目前转空比
  int uart_counter=0;
  int bit16_data16[9];//陀螺仪相关
  ...
  { 
    ...
    camera(road_data,center_line); //////摄像头返回道路数据
